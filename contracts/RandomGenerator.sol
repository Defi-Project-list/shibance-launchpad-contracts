...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public shibanceLotteryFactory;
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == shibanceLotteryFactory, "Only shibanceLotteryFactory");
    ...
    /**
     * @notice Set the address for the shibanceLotteryFactory
     * @param _shibanceLotteryFactory: address of the PancakeSwap lottery
     */
    function setLotteryAddress(address _shibanceLotteryFactory) external onlyOwner {
        shibanceLotteryFactory = _shibanceLotteryFactory;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IShibanceLotteryFactory(shibanceLotteryFactory).viewLastLotteryId();
    }
}